  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 widget footer-widget">
        ...
        Firas.Chakroun@enis.tn</br>
        Adam.Bahri@enis.tn</br>
        (+216) 50 786 408</br>
        (+216) 97 679 942
  ...
  <div class="container">
    <div class="row">
      <div class="copyrights-col-left col-md-6 col-sm-6">
        <p>&copy; 2022 Sacro blog</p>
      </div>
      <div class="copyrights-col-right col-md-6 col-sm-6">
        <div class="social-icons"> <a href="https://www.facebook.com" target="_blank"><i class="fa fa-facebook"></i></a>
          <a href="https://twitter.com?>" target="_blank"><i class="fa fa-twitter"></i></a> <a
            href="https://instagram.com/" target="_blank"><i class="fa fa-instagram"></i></a></div>
      </div>
    </div>
  </div>
</footer>
